...
impl DriveIndex {
    ...
    fn update_sorting_choice(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::UpdateSortingChoice {
    ...
    fn handle_action(&mut self, action: &DriveIndexAction, ctx: &mut ViewContext<Self>) {
        ...
        match action {
            ...
            DriveIndexAction::CopyObjectToClipboard(cloud_object_type_and_id) => {
                /* send_telemetry_from_ctx!(TelemetryEvent::CopyObjectToClipboard(cloud_object_type_and_id.into()),
                ctx); */
            ...
            DriveIndexAction::DuplicateObject(cloud_object_type_and_id) => {
                /* send_telemetry_from_ctx!(TelemetryEvent::DuplicateObject(cloud_object_type_and_id.into()),
                ctx); */
            ...
            DriveIndexAction::CopyObjectLinkToClipboard(link) => {
                /* send_telemetry_from_ctx!(TelemetryEvent::ObjectLinkCopied { link: link.clone() },
                ctx); */
                ctx.clipboard()
            ...
            DriveIndexAction::ViewPlans { team_uid } => {
                ...
                /* send_telemetry_from_ctx!(TelemetryEvent::SharedObjectLimitHitBannerViewPlansButtonClicked,
                ctx); */
            }
