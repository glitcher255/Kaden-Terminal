...
impl RootView {
    pub fn new(
        ...
        // Glitcher - Skip login screen (on boarding) and go straight to terminal
    ...
    fn resolve_account_first_post_auth(
        ...
        /* send_telemetry_from_ctx!(OnboardingEvent::OnboardingAuthCompleted {
    ...
    fn handle_account_first_workspaces_event(
        ...
        if upgrade_started {
            /* send_telemetry_from_ctx!(OnboardingEvent::OnboardingUpgradeCompleted {
    ...
    fn complete_account_first(
        ...
        /* send_telemetry_from_ctx!(OnboardingEvent::OnboardingCompleted {
        ...
        match event {
            ...
            AgentOnboardingEvent::UpgradeRequested => {
                ...
                if let Some(_account_class) = upgrade_started {
                    /* send_telemetry_from_ctx!(OnboardingEvent::OnboardingUpgradeStarted {
                        source_slide: match account_class {
                            FtueAccountClass::FreeIcp => "head_start",
                            FtueAccountClass::FreeStandard => "choose_how_to_start",
                            FtueAccountClass::Paid => "unknown",
