...
impl NotebookView {
    ...
    fn check_edited(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        if self.send_edit_telemetry {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::EditNotebook {
    ...
    fn send_telemetry_action(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::NotebookAction(NotebookActionEvent {
            action,
            metadata: self.telemetry_metadata(ctx)
        }),
        ctx); */
    ...
    pub fn load(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::OpenNotebook(self.open_telemetry_metadata(ctx)),
        ctx); */
    ...
    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        match action {
            ...
            NotebookAction::OpenLinkOnDesktop(url) => {
                /* send_telemetry_from_ctx!(TelemetryEvent::WebCloudObjectOpenedOnDesktop {
