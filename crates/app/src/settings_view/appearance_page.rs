        ...
        match action {
            ...
            ToggleFocusPaneOnHover => {
                PaneSettings::handle(ctx).update(ctx, |pane_settings, ctx| {
                    ...
                    {
                        Ok(_new_val) => {
                            /* send_telemetry_from_ctx!(TelemetryEvent::ToggleFocusPaneOnHover { enabled: new_val },
                            ctx); */
                        }
                        Err(e) => {
                            report_error!(e);
            ...
            ToggleAltScreenPadding => {
                ...
                /* send_telemetry_from_ctx!(TelemetryEvent::UpdateAltScreenPaddingMode { new_mode },
                ctx); */
            }
            UpdateAltScreenPaddingMode(new_mode) => {
                ...
                self.set_alt_screen_padding_editor_text(ctx);
                /* send_telemetry_from_ctx!(TelemetryEvent::UpdateAltScreenPaddingMode {
                    new_mode: *new_mode,
                },
                ctx); */
            }
...
impl AppearanceSettingsPageView {
    ...
    fn set_opacity(
        ...
        if should_set_defaults {
            /* send_telemetry_from_ctx!(TelemetryEvent::SetOpacity {
    ...
    fn set_blur(
        ...
        if should_set_defaults {
            /* send_telemetry_from_ctx!(TelemetryEvent::SetBlurRadius {
    ...
    fn reset_line_height_ratio(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::SetLineHeight {
    ...
    pub fn toggle_open_windows_at_custom_size(&mut self, ctx: &mut ViewContext<Self>) {
        WindowSettings::handle(ctx).update(ctx, |window_settings, ctx| {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::ToggleNewWindowsAtCustomSize { enabled: new_val },
            ctx); */
            report_if_error!(
                window_settings
                    .open_windows_at_custom_size
    ...
    fn set_thin_strokes(&mut self, value: &ThinStrokes, ctx: &mut ViewContext<Self>) {
        FontSettings::handle(ctx).update(ctx, |font_settings, ctx| {
            match font_settings.use_thin_strokes.set_value(*value, ctx) {
                Ok(_) => {
                    /* send_telemetry_from_ctx!(TelemetryEvent::ThinStrokesSettingChanged { new_value: *value },
                    ctx); */
                }
                Err(e) => {
                    report_error!(e);
    ...
    pub fn toggle_jump_to_bottom_of_block_button(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleJumpToBottomofBlockButton { enabled: new_value },
        ctx); */
    ...
    pub fn toggle_show_block_dividers(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleShowBlockDividers { enabled: new_value },
        ctx); */
        ctx.update_model(&block_list_settings, move |block_list_settings, ctx| {
            report_if_error!(
                block_list_settings
    ...
    pub fn toggle_dim_inactive_panes(&mut self, ctx: &mut ViewContext<Self>) {
        PaneSettings::handle(ctx).update(ctx, |pane_settings, ctx| {
            ...
            {
                Ok(_new_value) => {
                    /* send_telemetry_from_ctx!(TelemetryEvent::ToggleDimInactivePanes { enabled: new_value },
                    ctx); */
                }
                Err(e) => {
                    report_error!(e);
    ...
    fn set_input_type(&mut self, new_type: InputBoxType, ctx: &mut ViewContext<Self>) {
        ...
        if old_type != new_type {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::InputUXModeChanged {
                is_udi_enabled,
    ...
    fn set_app_icon(&mut self, new_icon: AppIcon, ctx: &mut ViewContext<Self>) {
        AppIconSettings::handle(ctx).update(ctx, |app_icon_settings, ctx| {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::AppIconSelection {
    ...
    fn set_cursor_type(&mut self, new_cursor_type: CursorDisplayType, ctx: &mut ViewContext<Self>) {
        AppEditorSettings::handle(ctx).update(ctx, |app_editor_settings, ctx| {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::CursorDisplayType {
    ...
    fn toggle_tab_indicators(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleTabIndicators { enabled: new_value },
        ctx); */
    }
    ...
    fn toggle_preserve_active_tab_color(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::TogglePreserveActiveTabColor { enabled: new_value },
        ctx); */
    }
    ...
    fn set_workspace_decoration_visibility(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleWorkspaceDecorationVisibility {
            previous_value,
            new_value
        },
        ctx); */
    ...
    fn toggle_ligature_rendering(&mut self, ctx: &mut ViewContext<Self>) {
        if FeatureFlag::Ligatures.is_enabled() {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::ToggleLigatureRendering { enabled: new_value },
            ctx); */
        }
    }
    ...
    pub fn update_tab_close_button_position(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::TabCloseButtonPositionUpdated { position },
        ctx); */
        ctx.notify();
    }
}
