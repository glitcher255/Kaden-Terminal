    ...
    fn start_grok_oauth(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        let attempt = match oauth::OauthAttempt::start() {
            ...
            Err(err) => {
                ...
                /* send_telemetry_from_ctx!(TelemetryEvent::SuperGrokSubscriptionConnectFinished {
        ...
        ctx.spawn(async move { attempt.finish().await }, |me, result, ctx| {
            ...
            let toast = match result {
                Ok(tokens) => {
                    ...
                    /* send_telemetry_from_ctx!(TelemetryEvent::SuperGrokSubscriptionConnectFinished { error: None },
                    ctx); */
        ...
        match action {
            ...
            WarpAgentPageAction::ToggleGlobalAI => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleGlobalAI {
            ...
            WarpAgentPageAction::ToggleActiveAI => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleActiveAI {
            ...
            WarpAgentPageAction::ToggleIntelligentAutosuggestions => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleIntelligentAutosuggestionsSetting {
            ...
            WarpAgentPageAction::TogglePromptSuggestions => {
                ...
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::TogglePromptSuggestionsSetting {
            ...
            WarpAgentPageAction::ToggleCodeSuggestions => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleCodeSuggestionsSetting {
            ...
            WarpAgentPageAction::ToggleNaturalLanguageAutosuggestions => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleNaturalLanguageAutosuggestionsSetting {
            ...
            WarpAgentPageAction::ToggleSharedTitleGeneration => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleSharedBlockTitleGenerationSetting {
            ...
            WarpAgentPageAction::ToggleGitOperationsAutogen => {
                ...
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleGitOperationsAutogenSetting {
            ...
            WarpAgentPageAction::ToggleUseAgentToolbar => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleUseAgentToolbarSetting {
            ...
            WarpAgentPageAction::ToggleVoiceInput => {
                match AISettings::handle(ctx).update(ctx, |settings, ctx| {
                    ...
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleVoiceInputSetting {
            ...
            WarpAgentPageAction::ToggleShowInputHintText => {
                InputSettings::handle(ctx).update(ctx, |input_settings, ctx| {
                    ...
                    /* send_telemetry_from_ctx!(// We purposely keep the FeaturesPageAction event, even though we have moved the setting to AI settings.
            ...
            WarpAgentPageAction::ToggleAiCommandSearchHashTrigger => {
                InputSettings::handle(ctx).update(ctx, |input_settings, ctx| {
                    ...
                    /* send_telemetry_from_ctx!(TelemetryEvent::FeaturesPageAction {
            ...
            WarpAgentPageAction::ToggleShowAgentTips => {
                ...
                {
                    Ok(_new_value) => {
                        /* send_telemetry_from_ctx!(TelemetryEvent::ToggleShowAgentTips {
                            is_enabled: new_value,
                        },
                        ctx); */
                    }
