        ...
        match action {
            CodeIndexingPageAction::ToggleCodebaseContext => {
                ...
                CodeSettings::handle(ctx).update(ctx, |settings, ctx| {
                    match settings.codebase_context_enabled.toggle_and_save_value(ctx) {
                        Ok(_new_value) => {
                            /* send_telemetry_from_ctx!(TelemetryEvent::ToggleCodebaseContext {
            ...
            CodeIndexingPageAction::ToggleAutoIndexing => {
                CodeSettings::handle(ctx).update(ctx, |settings, ctx| {
                    match settings.auto_indexing_enabled.toggle_and_save_value(ctx) {
                        Ok(_new_value) => {
                            /* send_telemetry_from_ctx!(TelemetryEvent::ToggleAutoIndexing {
            ...
            CodeIndexingPageAction::ToggleLspServer {
                ...
                if *currently_enabled {
                    ...
                    /* send_telemetry_from_ctx!(LspTelemetryEvent::ServerRemoved {
            ...
            CodeIndexingPageAction::RestartLspServer { server } => {
                ...
                /* send_telemetry_from_ctx!(LspTelemetryEvent::ControlAction {
