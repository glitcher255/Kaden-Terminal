...
impl UpdateEnvironmentForm {
    ...
    fn apply_suggest_image_success(
        ...
        /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::ImageSuggested {
            image,
            needs_custom_image,
        },
        ctx); */
                ...
                match result {
                    Ok(result) => match result {
                        ...
                        warp_graphql::queries::suggest_cloud_environment_image::SuggestCloudEnvironmentImageResult::UserFacingError(_) => {
                            ...
                            /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::ImageSuggestionFailed {
        ...
        match action {
            UpdateEnvironmentFormAction::Submit => {
                ...
                match &self.mode {
                    ...
                    EnvironmentFormMode::Edit { env_id } => {
                        /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::EnvironmentUpdated {
            ...
            UpdateEnvironmentFormAction::Delete => {
                if let EnvironmentFormMode::Edit { env_id } = &self.mode {
                    /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::EnvironmentDeleted {
                        environment_id: env_id.into_server(),
                    },
                    ctx); */
            ...
            UpdateEnvironmentFormAction::LaunchAgentForSelectedRepos => {
                /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::LaunchedAgentFromEnvironmentForm,
                ctx); */
            ...
            UpdateEnvironmentFormAction::StartGithubAuth => {
                /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::GitHubAuthFromEnvironmentForm,
                ctx); */
