...
impl TemplatableMCPServerManager {
    ...
    fn spawn_server_impl(
        ...
        let task = ctx.spawn(
            ...
            move |me, server_info: Result<_, rmcp::RmcpError>, ctx| {
                ...
                let _error: Option<String> = match server_info {
                    Ok(info) => {
                        let peer = info.peer();
                ...
                if should_send_telemetry {
                    /* send_telemetry_from_ctx!(TelemetryEvent::MCPServerSpawned {
    ...
    fn convert_all_legacy_to_templatable(
        ...
        for cloud_legacy_server in cloud_legacy_servers {
            ...
            match result {
                Ok(_result) => {
                    /* send_telemetry_from_ctx!(TelemetryEvent::MCPTemplateCreated {
