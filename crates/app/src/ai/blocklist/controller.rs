...
impl BlocklistAIController {
    ...
    fn send_query(
        ...
        if matches!(user_query_mode, UserQueryMode::Orchestrate) {
            /* send_telemetry_from_ctx!(super::telemetry::BlocklistOrchestrationTelemetryEvent::OrchestrationEntered(
    ...
    fn send_request_input(
        ...
        if self
            ...
            .has_active_stream_for_conversation(conversation_id, ctx)
        {
            /* send_telemetry_from_ctx!(TelemetryEvent::AIInputNotSent {
