...
impl CLISubagentView {
    ...
    fn handle_execute_blocked_action(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::CLISubagentActionExecuted {
    ...
    fn handle_reject_blocked_action(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::CLISubagentActionRejected {
            conversation_id: self.conversation_id,
            block_id: self.block_id.clone(),
    ...
    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        match action {
            ...
            CLISubagentAction::DismissInput => {
                ...
                ctx.notify();
                /* send_telemetry_from_ctx!(TelemetryEvent::CLISubagentInputDismissed {
                    conversation_id: self.conversation_id,
                    block_id: self.block_id.clone(),
                },
                ctx); */
