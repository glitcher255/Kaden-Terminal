...
use crate::ai::blocklist::telemetry::{RunAgentsCardDecision, run_agents_card_decision_event};
...
impl RunAgentsCardView {
    ...
    fn emit_orchestration_entered_once(
        ...
        /* send_telemetry_from_ctx!(BlocklistOrchestrationTelemetryEvent::OrchestrationEntered(OrchestrationEnteredEvent {
            conversation_id,
    ...
    fn emit_decision(&mut self, decision: RunAgentsCardDecision, ctx: &mut ViewContext<Self>) {
        ...
        let _event = run_agents_card_decision_event(
            conversation_id,
        ...
        /* send_telemetry_from_ctx!(BlocklistOrchestrationTelemetryEvent::RunAgentsCardDecision(event),
        ctx); */
    }
