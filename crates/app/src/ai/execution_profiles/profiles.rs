...
impl AIExecutionProfilesModel {
    ...
    pub fn set_base_model(
        ...
        if let Some(_model_id) = &llm_id {
            /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileModelSelected {
    ...
    pub fn set_context_window_limit(
        ...
        if changed && limit.is_some() {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileContextWindowSelected {
                tokens: limit,
    ...
    pub fn set_apply_code_diffs(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileSettingUpdated {
    ...
    pub fn add_to_command_allowlist(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileAddedToAllowlist {
    ...
    pub fn remove_from_command_allowlist(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileRemovedFromAllowlist {
            list_type: "command".to_string(),
            value: predicate.to_string(),
        },
        ctx); */
    ...
    pub fn add_to_command_denylist(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileAddedToDenylist {
            list_type: "command".to_string(),
            value: predicate.to_string(),
        },
        ctx); */
    ...
    pub fn remove_from_command_denylist(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::AIExecutionProfileRemovedFromDenylist {
            list_type: "command".to_string(),
            value: predicate.to_string(),
        },
        ctx); */
