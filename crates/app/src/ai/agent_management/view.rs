    ...
    fn handle_action_buttons_event(
        ...
        match event {
            ...
            AgentDetailsButtonEvent::CancelTask { task_id } => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::CloudRunCancelled {
            ...
            AgentDetailsButtonEvent::ForkConversation { conversation_id } => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::ConversationForked {
            ...
            AgentDetailsButtonEvent::ViewDetails { item_id } => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::DetailsViewed {
            ...
            AgentDetailsButtonEvent::CopyLink { link } => {
                match item_id {
                    ManagementCardItemId::Conversation(_conversation_id) => {
                        /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::ConversationLinkCopied {
                            conversation_id: conversation_id.to_string(),
                    ...
                    ManagementCardItemId::AmbientRun(_task_id) => {
                        /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::SessionLinkCopied {
                            task_id: task_id.to_string(),
                            copied_from: OpenedFrom::ManagementView,
                        },
                        ctx); */
    ...
    fn handle_artifact_buttons_event(
        ...
        match event {
            ArtifactButtonsRowEvent::OpenPlan { notebook_uid } => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::ArtifactClicked {
    ...
    fn handle_agent_type_selector_event(
        ...
        match event {
            AgentTypeSelectorEvent::Selected(agent_type) => {
                ...
                match agent_type {
                    AgentType::Cloud => {
                        /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::SpawnNewCloudAgent,
                        ctx); */
                        ctx.dispatch_typed_action(&WorkspaceAction::AddAmbientAgentTab);
                    }
                    AgentType::Local => {
                        /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::SpawnNewLocalAgent,
                        ctx); */
    ...
    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        match action {
            AgentManagementViewAction::SetOwnerFilter(filter) => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::FilterChanged {
            ...
            AgentManagementViewAction::ShowAgentTypeSelector => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::AgentTypeSelectorOpened,
                ctx); */
            ...
            AgentManagementViewAction::OpenSession { item_id } => {
                ...
                match item_id {
                    ManagementCardItemId::Conversation(_conversation_id) => {
                        /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::ConversationOpened {
                            conversation_id: conversation_id.to_string(),
                    ...
                    ManagementCardItemId::AmbientRun(_task_id) => {
                        /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::CloudRunOpened {
                            task_id: task_id.to_string(),
                            opened_from: OpenedFrom::ManagementView,
                        },
                        ctx); */
