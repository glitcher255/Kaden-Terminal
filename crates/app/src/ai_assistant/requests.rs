                ...
                if let RequestStatus::InFlight { request, .. } = current_request_status {
                    match response {
                        Ok(GenerateDialogueResult::Success {
                            ...
                            /* send_telemetry_from_ctx!(TelemetryEvent::WarpAIRequestIssued { result: WarpAIRequestResult::Succeeded { latency_ms: req_latency, truncated }},
                            ctx); */
                        }
                        Ok(GenerateDialogueResult::Failure { request_limit_info }) if request_limit_info.limit <= request_limit_info.num_requests_used_since_refresh => {
                            ...
                            /* send_telemetry_from_ctx!(TelemetryEvent::WarpAIRequestIssued { result: WarpAIRequestResult::OutOfRequests},
                            ctx); */
                        }
                        _ => {
                            ...
                            /* send_telemetry_from_ctx!(TelemetryEvent::WarpAIRequestIssued { result: WarpAIRequestResult::Failed},
                            ctx); */
                        }
                    }
                }
