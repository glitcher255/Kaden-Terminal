...
impl ShareBlockModal {
    ...
    pub fn save_block(&mut self, share_type: ShareBlockType, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::GenerateBlockSharingLink {
            share_type,
    ...
    pub fn copy(&mut self, ctx: &mut ViewContext<Self>) {
        if let Some(link) = self.link() {
            /* send_telemetry_from_ctx!(TelemetryEvent::CopyBlockSharingLink(ShareBlockType::Permalink),
            ctx); */
    ...
    pub fn copy_embed(&self, ctx: &mut ViewContext<Self>) {
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::CopyBlockSharingLink(ShareBlockType::HtmlEmbed),
        ctx); */
        ctx.clipboard()
