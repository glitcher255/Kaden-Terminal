...
// Glitcher - Default keybindings mapping in settings - for [`TerminalView`] actions.
pub fn init(app: &mut AppContext) {
    use warpui::keymap::macros::*;
    app.register_binding_validator::<TerminalView>(is_binding_pty_compliant);
    init_overlapping_keybindings(app);
    // Register input mode bindings before warpify bindings so ctrl-i warpifies instead of opening inline agent when a warpify banner is visible.
    ...
    app.register_editable_bindings([
        ...
        // Glitcher
        // Smart copy / kill
        // Why is this hotkey hard-coded here? why not use Editable bindings?? todo version 1.1
        EditableBinding::new(
            "terminal:cancel_command",  //"terminal:cancel_command" - CANCEL_COMMAND_KEYBINDING
            // if cfg!(windows) {
            //     "Copy or kill active process"
            // } else {
    ...
    app.register_editable_bindings([
        ...
        // identical to copy, different hotkey
        EditableBinding::new(
            "terminal:copy",
        ...
        // // similar to copy, different hotkey
        EditableBinding::new(
    ...
    // This is never used, should trim
    ...
    // Keybindings (probably extract this from here)
    else {
        app.register_editable_bindings([EditableBinding::new(
            "terminal:select_all_blocks",
            "Select all blocks",
    ...
    ///////// AI BINDINGS /////////
    ///////// AI BINDINGS /////////
    // AI keybindings, not visable by default
    app.register_editable_bindings([
        EditableBinding::new(
    ...
    // AI keybindings, not shown by default
    app.register_editable_bindings([
        EditableBinding::new(
    ...
    .with_context_predicate(id!("Terminal"))]);
    // AI bindings - Register bindings for starting a new cloud agent conversation.
    {
