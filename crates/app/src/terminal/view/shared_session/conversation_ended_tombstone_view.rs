        ...
        ctx.subscribe_to_view(
            ...
            |_, _, event, ctx| match event {
                ArtifactButtonsRowEvent::OpenPlan { notebook_uid } => {
                    /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::TombstoneArtifactClicked {
...
impl TypedActionView for ConversationEndedTombstoneView {
    ...
    fn handle_action(&mut self, action: &Self::Action, ctx: &mut ViewContext<Self>) {
        match action {
            ConversationEndedTombstoneAction::ContinueInCloud { task_id } => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::TombstoneContinueInCloud {
            ...
            #[cfg(not(target_family = "wasm"))]
            ConversationEndedTombstoneAction::ContinueLocally(conversation_id) => {
                /* send_telemetry_from_ctx!(AgentManagementTelemetryEvent::TombstoneContinueLocally,
                ctx); */
