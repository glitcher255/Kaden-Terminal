...
impl TerminalView {
    ...
    pub fn attempt_to_share_session(
        ...
        if let Some(_action_source) = action_source {
            /* send_telemetry_from_ctx!(TelemetryEvent::StartedSharingCurrentSession {
    ...
    fn stop_sharing_session_for_reason(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::StoppedSharingCurrentSession { source, reason },
        ctx); */
    }
    ...
    pub fn on_session_share_joined(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::JoinedSharedSession {
            session_id,
            source_type,
        },
        ctx); */
    ...
    fn scroll_to_shared_session_participant_selection(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::JumpToSharedSessionParticipant {
