...
impl AmbientAgentViewModel {
    ...
    pub(crate) fn monitor_created_handoff(
        ...
        /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::HandoffSnapshotPrepared {
    ...
    pub(crate) fn handle_handoff_commit_failure(
        ...
        if let Some(_derived_workspace_had_content) = failure.derived_workspace_had_content {
            /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::HandoffSnapshotPrepared {
    ...
    fn handle_ambient_agent_stream_error(
        ...
        /* send_telemetry_from_ctx!(CloudAgentTelemetryEvent::DispatchFailed {
