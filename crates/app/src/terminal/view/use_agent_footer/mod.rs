...
use crate::server::telemetry::{CLIAgentType, FileTreeSource};
use crate::settings::{
...
impl TerminalView {
    ...
    fn handle_use_agent_footer_event(
        ...
        match event {
            ...
            UseAgentToolbarEvent::Warpify => {
                ...
                /* send_telemetry_from_ctx!(TelemetryEvent::WarpifyFooterAcceptedWarpify { is_ssh: false },
                ctx); */
            }
    ...
    pub(super) fn tag_in_agent_for_user_long_running_command(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::CLISubagentControlStateChanged {
            conversation_id,
            block_id,
    ...
    pub(super) fn maybe_show_use_agent_footer_in_blocklist(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        if let Some(session) = CLIAgentSessionsModel::as_ref(ctx).session(self.view_id) {
            ...
            /* send_telemetry_from_ctx!(TelemetryEvent::CLIAgentToolbarShown {
    ...
    fn close_cli_agent_rich_input_impl(
        ...
        if let Some(_cli_agent) = cli_agent_type {
            /* send_telemetry_from_ctx!(TelemetryEvent::CLIAgentRichInputClosed { cli_agent, reason },
            ctx); */
        }
    ...
    pub(super) fn submit_cli_agent_rich_input(
        ...
        if let Some(_cli_agent) = cli_agent {
            /* send_telemetry_from_ctx!(TelemetryEvent::CLIAgentRichInputSubmitted {
                cli_agent,
                prompt_length,
            },
            ctx); */
    ...
    pub(in crate::terminal) fn open_cli_agent_rich_input(
        ...
        /* send_telemetry_from_ctx!(TelemetryEvent::CLIAgentRichInputOpened {
